...
public class infodeneme {
	...
	public void testInfodeneme() throws Exception {
		...
		assertEquals("n11.com - Alýþveriþin Uðurlu Adresi", selenium.getTitle());
		selenium.click("link=Giriþ Yap");
		//selenium.waitForPageToLoad("30000");
		assertEquals("Giriþ Yap - n11.com", selenium.getTitle());
		...
		selenium.waitForPageToLoad("30000");
		assertEquals("Hesabým - n11.com", selenium.getTitle());
		selenium.click("xpath=(//a[contains(text(),'Favorilerim')])[2]");
		selenium.waitForPageToLoad("30000");
		assertEquals("Favorilerim - n11.com", selenium.getTitle());
		assertEquals(bir, selenium.getText("link=SAMSUNG G900F GALAXY S5 16GB Cep Telefonu / BEYAZ / SÝYAH"));
